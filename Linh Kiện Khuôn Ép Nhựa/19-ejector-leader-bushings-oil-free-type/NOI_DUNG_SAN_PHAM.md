# NỘI DUNG SẢN PHẨM - EGBZS EJECTOR LEADER BUSHING (OIL-FREE TYPE)
...
- Thiết bị tự động hóa với ejector mechanism (Automation Equipment)
- Hệ thống dẫn hướng chính xác cho ejector plate
...
✓ **Dung sai chính xác**: H7/h6 đảm bảo khớp nối hoàn hảo  
✓ **Tuổi thọ cao**: Chống mài mòn vượt trội, tăng 2-3 lần so với ống lót thường  
✓ **Giảm ma sát**: Vận hành êm ái, giảm nhiệt ma sát  
✓ **Vai định vị**: Lắp đặt nhanh, chính xác, không bị lệch  
...
- **Ứng dụng**: Ejector Leader Bushing (Dẫn hướng đẩy phôi)
- **Dung sai đường kính trong**: H7 (ISO tolerance)
- **Dung sai đường kính ngoài**: h6 (ISO tolerance)
- **Rãnh định vị**: S = 4mm (0/-0.05mm)
- **Phạm vi kích thước d**: φ13 ~ φ25mm
...
| Chiều dài thân | L | 10 ~ 30 | mm | ±0.3 | Nhiều option tiêu chuẩn |
| Rãnh định vị | S | 4 | mm | 0/-0.05 | Cố định cho mọi size |
| Độ dày thành | t | 1.6 | mm | - | Tiêu chuẩn |
...
| Chiều dài | L | ±0.3 | Tolerance tiêu chuẩn |
| Rãnh S | S | 0/-0.05 | Chống xoay, định vị chính xác |
| Các kích thước khác | - | -0.5/-0.8 hoặc -0.2/-0.1 | Theo bản vẽ kỹ thuật |
...
| 16 | 28 | 28 | 4 | 1.6 | 10, 13, 15, 20, 25 |
| 20 | 30 | 30 | 4 | 1.6 | 10, 15, 20, 25 |
| 20 | 33 | 33 | 4 | 1.6 | 15, 20, 25, 30 |
| 25 | 35 | 35 | 4 | 1.6 | 15, 20, 25, 30 |
| 25 | 38 | 38 | 4 | 1.6 | 20, 25 |

### Bảng Kích Thước Chi Tiết theo từng Đường kính d
...
- Độ dày thành t = 1.6mm cho tất cả các size
...
1. **Chọn D/H phù hợp**: Mỗi d có 2 options D/H
   - Option nhỏ hơn (compact): Tiết kiệm không gian
   - Option lớn hơn (standard): Độ bền cao hơn

2. **Kiểm tra L available**: Không phải mọi L đều có sẵn cho mọi D/H
   - Xem kỹ bảng kích thước tiêu chuẩn
   - Chiều dài L tùy chỉnh cần MOQ

3. **Rãnh S luôn là 4mm**: Cố định cho mọi size, không cần chọn

### Alterations/Tùy chỉnh đặc biệt

**Các tùy chọn customization có sẵn**:

1. **Chiều dài L đặc biệt** (không có trong bảng tiêu chuẩn)
   - Minimum Order Quantity (MOQ): 50 pieces
   - Lead time: 2-3 tuần
   - Mã code: Ghi rõ L cần customization

2. **Đường kính D/H tùy chỉnh**
   - Điều chỉnh D và H theo yêu cầu thiết kế cụ thể
   - MOQ: 100 pieces
   - Cần bản vẽ kỹ thuật chi tiết
   - Mã code: thêm "-Custom" vào cuối mã

3. **Rãnh S tùy chỉnh**
   - Thay đổi chiều rộng rãnh S (mặc định 4mm)
   - MOQ: 50 pieces
   - Mã code: thêm "-S[value]" (VD: EGBZS-d20-30-20-S5)

4. **Graphite content tùy chỉnh**
   - Tăng/giảm tỷ lệ graphite theo yêu cầu
   - Phù hợp cho điều kiện hoạt động đặc biệt
   - Liên hệ bộ phận kỹ thuật

5. **Độ dày thành t tùy chỉnh**
   - Thay đổi từ 1.6mm tiêu chuẩn
   - Cần tính toán kỹ thuật
   - MOQ: 100 pieces
...
- Có thể yêu cầu sample trước khi sản xuất hàng loạt
...
1. **Hình ảnh sản phẩm thực tế** (4-6 ảnh):
   - ✓ Góc nghiêng 45° thể hiện H-Type structure
   - ✓ Góc chính diện thấy rõ vai và rãnh S
   - ✓ Góc cận cảnh rãnh S (4mm groove detail)
   - ✓ Góc cận cảnh bề mặt tự bôi trơn
   - ✓ Nhóm sản phẩm nhiều kích thước khác nhau
   - ✓ Sản phẩm lắp trong ejector system (nếu có)
   - ✓ Comparison với standard bushing (không oil-free)

2. **Hình ảnh bản vẽ kỹ thuật** (đã xóa tên công ty nguồn):
   - ✓ Technical drawing với kích thước đầy đủ
   - ✓ Detail view của vai H-Type
   - ✓ Detail view của rãnh S (cross-section)
   - ✓ Cross-section view (mặt cắt ngang) thể hiện độ dày thành
   - ✓ Isometric view (hình chiếu 3D)
   - ✓ Assembly drawing trong ejector system

3. **Hình ảnh bảng thông số** (đã xóa thông tin nhà sản xuất gốc):
   - ✓ Bảng dung sai chi tiết (H7, h6)
   - ✓ Bảng kích thước tiêu chuẩn đầy đủ
   - ✓ Material specification chart (Brass + Graphite)
...
5. **Hình ảnh ứng dụng và so sánh**:
   - ✓ Installation trong ejector plate
   - ✓ Before/After comparison (standard vs oil-free)
   - ✓ Wear comparison (tuổi thọ cao hơn)
   - ✓ Application in plastic injection mold

6. **Hình ảnh minh họa**:
   - ✓ H-Type structure illustration
   - ✓ S-groove function illustration (chống xoay)
   - ✓ Self-lubricating mechanism diagram
...
7. **Yêu cầu kỹ thuật**:
   ...
   - Highlight rõ ràng rãnh S trong các ảnh
...
- **Hiển thị tự động**: S=4mm, t=1.6mm, dung sai H7/h6
...
☑ **Website chính** - Ưu tiên cao nhất  
  → Sản phẩm kỹ thuật B2B chuyên sâu, cần catalog chi tiết và hướng dẫn kỹ thuật

☑ **Lazada.vn**  
  → Tiếp cận khách hàng SME, xưởng gia công khuôn mẫu

☐ **Tiki.vn**  
  → Tùy chọn (sản phẩm chuyên dụng, segment khách hàng hẹp hơn)

☐ **Shopee.vn**  
  → Không ưu tiên (sản phẩm quá chuyên nghiệp)
...
- **Marketing approach**:
  ...
  - Video tutorials: Lắp đặt và bảo dưỡng
  - Case studies: So sánh tuổi thọ oil-free vs standard
...
- Lợi ích vượt trội về chi phí bảo dưỡng và tuổi thọ
- Phù hợp với xu hướng Industry 4.0 (giảm bảo dưỡng, tăng uptime)
...
- **Ứng dụng**: khuôn ép nhựa, ejector system, ejector plate, plastic mold, đẩy phôi
- **Thương hiệu**: YAS-TEK
...
- **Application Keywords**: ejector system, ejector plate, khuôn ép nhựa
- **Feature Keywords**: rãnh S, H-type, tự bôi trơn, chống xoay
- **Brand Keywords**: YAS-TEK ejector, YAS-TEK EGBZS
...
```json
{
  ...
  "@type": "Product",
  "name": "EGBZS Ejector Leader Bushing - Oil-Free Type - H-Type - Copper Alloy",
  "description": "Ống lót dẫn hướng ejector H-Type tự bôi trơn với rãnh S chống xoay",
  "brand": {
    "@type": "Brand",
    "name": "YAS-TEK"
  },
  "category": "Linh Kiện Khuôn Ép Nhựa - Ejector Components",
  "material": "Brass + Graphite",
  "additionalProperty": [
    {
      "@type": "PropertyValue",
      "name": "Type",
      "value": "H-Type with S-Groove"
    },
    {
      "@type": "PropertyValue",
      "name": "Self-Lubricating",
      "value": "Yes"
    },
    {
      "@type": "PropertyValue",
      "name": "Application",
      "value": "Ejector System"
    },
    {
      "@type": "PropertyValue",
      "name": "S-Groove",
      "value": "4mm (anti-rotation)"
    },
    {
      "@type": "PropertyValue",
      "name": "Tolerance",
...
4. **Ổn định cao**: Không bị lệch trong quá trình vận hành
...
| **Ứng dụng** | Nhận guide pin/post | Lắp vào ejector plate |
| **Tolerance** | 0 đến âm | 0 đến âm |
...
**Mỗi d có 2 options D/H**:

1. **Option nhỏ hơn** (Compact):
   - Tiết kiệm không gian
   - Phù hợp khi khuôn có không gian hạn chế
   - Nhẹ hơn

2. **Option lớn hơn** (Standard):
   - Độ bền cao hơn
   - Chịu tải tốt hơn
   - Tuổi thọ lâu hơn
   - Khuyến nghị cho sản xuất khối lượng lớn
...
- [ ] Kiểm tra tất cả thông số kỹ thuật từ file info.txt
- [ ] Đảm bảo KHÔNG có thông tin nhà sản xuất gốc
- [ ] Logo YAS-TEK đã được thêm vào tất cả hình ảnh
- [ ] Watermark/logo nguồn đã được xóa hoàn toàn
- [ ] Bảng kích thước đã kiểm tra chính xác (8 configurations)
- [ ] Rãnh S = 4mm đã được highlight rõ ràng
- [ ] H-Type structure đã được giải thích đầy đủ
- [ ] Dung sai H7/h6 đã được ghi rõ
- [ ] Matrix biến thể d → D/H → L đã được cấu hình đúng
- [ ] URL thân thiện SEO đã được tạo
- [ ] Meta title và description đã tối ưu với keyword "ejector"
- [ ] Hình ảnh chất lượng cao, rõ nét (min 1200x1200px)
- [ ] Hình ảnh rãnh S đã được chụp chi tiết
- [ ] Tags và từ khóa đã đầy đủ, bao gồm "ejector", "H-type"
- [ ] Installation guide cho ejector system đã sẵn sàng
- [ ] Link download catalog (nếu có) đã hoạt động
- [ ] Thông tin liên hệ technical support đã chính xác
- [ ] Test hiển thị trên mobile và desktop
- [ ] Kiểm tra chính tả tiếng Việt
- [ ] Verify các thuật ngữ kỹ thuật tiếng Anh
...
- Tính năng **tự bôi trơn** - giảm downtime
- **Dung sai chính xác H7/h6** - chất lượng cao
- **Tuổi thọ cao** gấp 2-3 lần - ROI tốt
...
- Doanh nghiệp ưu tiên quality và low maintenance
...
- **Case study**: "Tăng tuổi thọ ejector system 3 lần với EGBZS oil-free"
- **Comparison chart**: "EGBZS vs Standard Ejector Bushing"
...
- Cross-reference với standard parts

---

*Nội dung được tạo bởi YAS-TEK Product Content Generator*  
*Phiên bản: 1.0*  
*Sản phẩm: EGBZS Ejector Leader Bushing - Oil-Free H-Type*  
*Ngày tạo: 31/01/2026*
