# NỘI DUNG SẢN PHẨM - GBOS OIL-FREE LEADER BUSHING (STRAIGHT TYPE)
...
- Máy móc công nghiệp yêu cầu thiết kế compact
...
✓ **Lắp đặt linh hoạt**: Dạng thẳng dễ tháo lắp, thay thế nhanh  
✓ **Chamfer tiện lợi**: Vát cạnh giúp lắp đặt dễ dàng hơn  
...
- **Dung sai đường kính ngoài**: -0.01/-0.03mm
- **Phạm vi kích thước d**: φ6 ~ φ60mm
- **Phạm vi chiều dài L**: 10 ~ 120mm
...
| Chamfer | t | 1 ~ 3 | mm | -0.5 | L=10→t=4, L=15→t=6 |
| Đường kính kích thước | Dm | Tùy theo d | mm | m5 | Theo bảng tiêu chuẩn |
...
| 12 | +0.011/+0.024 | 18 | -0.01/-0.03 |
| 13 | +0.011/+0.024 | 20 | -0.01/-0.03 |
| 16 | +0.011/+0.024 | 25 | -0.01/-0.03 |
| 20 | +0.010/+0.029 | 30 | -0.01/-0.03 |
| 25 | +0.010/+0.029 | 35 | -0.01/-0.03 |
| 30 | +0.010/+0.029 | 40 | -0.01/-0.03 |
| 35 | +0.010/+0.029 | 42 | -0.01/-0.03 |
| 40 | +0.010/+0.029 | 48 | -0.01/-0.03 |
| 50 | +0.010/+0.029 | 55 | -0.01/-0.03 |
| 60 | +0.010/+0.029 | 70 | -0.01/-0.03 |
...
| 12 | 18 | 14 | 1.6 | 15, 20, 25, 30, 35 |
| 13 | 20 | 16 | 1.6 | 15, 20, 25, 30, 35, 40, 50 |
| 16 | 25 | 20 | 1.6 | 15, 20, 25, 30, 35, 40, 50 |
| 20 | 30 | 25 | 1.6 | 15, 20, 25, 30, 35, 40, 50, 60, 70 |
| 25 | 35 | 30 | 1.6 | 20, 25, 30, 35, 40, 50, 60, 70 |
| 30 | 40 | 35 | 1.6 | 25, 30, 35, 40, 50, 60, 70, 80 |
| 35 | 42 | 40 | 1.6 | 25, 30, 40, 50, 60, 70, 80, 100 |
| 40 | 48 | 50 | 1.6 | 30, 40, 50, 60, 70, 80, 100, 120 |
...
| GBOS-50-100 | 50mm | 100mm | 55mm | 1.6mm | 60mm | Khuôn lớn |

### Lưu ý đặc biệt về Chamfer

- **L = 10mm**: Chamfer t = 4mm (lớn hơn tiêu chuẩn)
- **L = 15mm**: Chamfer t = 6mm (lớn hơn tiêu chuẩn)
- **L ≥ 20mm**: Chamfer t = 1~3mm (tiêu chuẩn)

Điều này giúp lắp đặt dễ dàng hơn với các ống lót ngắn.
...
2. **Chamfer tùy chỉnh**
   - Điều chỉnh kích thước chamfer theo yêu cầu
   - Mã code: thêm "-Ct[value]" vào cuối mã (VD: GBOS-20-50-Ct5)

3. **Đường kính ngoài D đặc biệt**
   - Tùy chỉnh D theo yêu cầu thiết kế cụ thể
...
1. **Hình ảnh sản phẩm thực tế** (3-5 ảnh):
   - ✓ Góc nghiêng 45° thể hiện dạng thẳng (straight type)
   - ✓ Góc chính diện thấy rõ đường kính và chiều dài
   - ✓ Góc cận cảnh bề mặt tự bôi trơn và chamfer
   - ✓ So sánh giữa GBOS (straight) và GBOF (headed) - nếu có
...
5. **Hình ảnh so sánh**:
   - ✓ GBOS vs GBOF (Straight Type vs Headed Type)
   - ✓ Installation comparison (so sánh lắp đặt)
   - ✓ Space saving illustration (minh họa tiết kiệm không gian)
...
- Hiển thị note về chamfer đặc biệt cho L=10 và L=15
...
☑ **Website chính** - Ưu tiên cao  
  → Sản phẩm kỹ thuật B2B, cần catalog chi tiết và comparison với GBOF
...
- Cung cấp tư vấn kỹ thuật qua chat/hotline để giúp chọn đúng loại
...
- Alternative cho GBOF khi không gian hạn chế
...
- **Differentiation Keywords**: straight type, không đầu vai, compact, space saving
- **Brand Keywords**: YAS-TEK bushing, YAS-TEK GBOS
...
```json
{
  ...
  "@type": "Product",
  "name": "GBOS Oil-Free Leader Bushing - Straight Type - Copper Alloy",
  "description": "Ống lót dẫn hướng thẳng tự bôi trơn từ hợp kim đồng + graphite, thiết kế compact",
  "brand": {
    "@type": "Brand",
    "name": "YAS-TEK"
  },
...
| **Chiều dài min** | 10mm | 15mm |
| **Chamfer** | Đặc biệt (4-6mm cho L ngắn) | Chuẩn (T=1.6-5mm) |
| **Ứng dụng** | Khuôn compact, space limited | Khuôn yêu cầu định vị chính xác |
| **Vật liệu** | Brass + Graphite | Brass + Graphite |
| **Tự bôi trơn** | Có | Có |
...
✓ Thiết kế compact  
✓ Cần chamfer lớn cho ống lót ngắn  
...
- [ ] Bảng kích thước đã kiểm tra chính xác
- [ ] Quy tắc chamfer đặc biệt đã được ghi rõ (L=10→t=4, L=15→t=6)
- [ ] Comparison với GBOF đã được tạo (nếu có)
- [ ] URL thân thiện SEO đã được tạo
- [ ] Meta title và description đã tối ưu
- [ ] Hình ảnh chất lượng cao, rõ nét (min 1200x1200px)
- [ ] Tags và từ khóa đã đầy đủ, bao gồm "straight type", "compact"
- [ ] Link download catalog (nếu có) đã hoạt động
- [ ] Thông tin liên hệ và hotline đã chính xác
...
- **Lắp đặt linh hoạt** - dễ tháo lắp hơn GBOF
...
- Doanh nghiệp cần thay thế bushing nhanh
...
- Case study: "Tiết kiệm 30% không gian với GBOS"
